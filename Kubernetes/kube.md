...
### Kyverno:
Kyverno is an open-source policy management tool for Kubernetes. It provides a policy engine that allows you to define and enforce policies on resources within your Kubernetes cluster.

These policies are typically used to ensure compliance, security, and operational best practices.
...
### ERIC start with portaffinity today